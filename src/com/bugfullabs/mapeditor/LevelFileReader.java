...
//		System.out.println("Entered startElement(" + namespaceURI + ", " + localName + ", " + qName + ", " + atts + ")");
		...
		if (qName.equals("level")) {
			...
			level = new Level(Integer.parseInt(atts.getValue("id")), Integer.parseInt(atts.getValue("levelpackid")), atts.getValue("texture"), Integer.parseInt(atts.getValue("columns"))*32, Integer.parseInt(atts.getValue("rows"))*32, -1, -1);
